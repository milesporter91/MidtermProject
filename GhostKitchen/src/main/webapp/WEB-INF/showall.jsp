				...
				<table class="table table-dark table-hover align-middle text-center">
					...
					<tbody>
						<c:forEach var="restaurant" items="${restaurants}">
							<tr>
								<td><img src="${restaurant.imageUrl}"
									alt="Restaurant Image"
									style="height: 60px; border-radius: 0.5rem;"></td>
								<td><a class="text-neon"
									href="showRestaurant.do?id=${restaurant.id}">
								...
								<td>
										<form action="disableRestuarant.do" method="POST">
											<input type="hidden" name="restaurantId"
												value="${restaurant.id}" /> <input type="submit"
