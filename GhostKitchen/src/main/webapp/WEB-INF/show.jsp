...
<body class="body-bg3">
  ...
  <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="neon-card p-4 text-center w-100" style="max-width: 600px;">
      ...
      <h1 class="text-neon mb-4">${restaurant.name}</h1>
      ...
      <form action="createReview.do" method="POST">
        ...
        <div class="mb-3">
          ...
          <div class="star-rating d-flex justify-content-center">
            <c:forEach var="i" begin="1" end="5">
              ...
              <label for="star${i}" class="bi bi-star-fill fs-3 me-2 star-hover text-light"></label>
            </c:forEach>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea name="comments" class="form-control" rows="3" placeholder="Write something..."></textarea>
        </div>
