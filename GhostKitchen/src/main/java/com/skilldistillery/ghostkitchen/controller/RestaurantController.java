...
public class RestaurantController {
	...
	public String updateRestaurant(Model model, Restaurant restaurant, @RequestParam("restaurantId") int id,
			HttpSession session) {
	...
	public String goToCreateForm(Model model, HttpSession session) {
	...
	public String findByCuisineType(@RequestParam("cuisineTypeName") String cuisineTypeName, Model model,
			HttpSession session) {
